...
; @function _get_file_stat_buffer
...
; @example
;   string "test.txt"
;   _get_file_stat_buffer rax  ; получает информацию о файле test.txt
_function _get_file_stat_buffer, rbx, rcx, r11
  get_arg 0
  mov rbx, rax
...
; @example
;   string "test.txt"
;   _get_file_size rax  ; возвращает размер файла test.txt
_function _get_file_size, rbx
  get_arg 0
  mov rbx, rax

  check_type rbx, STRING

  _get_file_stat_buffer rbx
